...
## 2026-09-23 (ночь)
Отдых у очага по E: HP+стамина, возрождение врагов. RestAtOchag общий для респавна и кнопки, FindNearestOchag, отдельный RespawnTimerHandle, убрана двойная очистка врагов. E не работает на спринте.